...
export default function FormSelectFile() {
    ...
    let maxSizes = [50, 100, 200, 500, 1000] //ขนาดสูงสุดของไฟล์
    ...
    return (
        ...
        <form>
            <div className="form-group mb-3">
                ...
                <select id="maxNumFileSize." className="form-select form-select-sm" ref={selectMaxNumFiles}>
                {
                    maxNumfiles.map(i => {
            ...
            <div className="form-group mb-3">
                <label htmlFor="maxSizes" className="form-label">ขนาดไฟล์สูงสุด (KB)</label>
